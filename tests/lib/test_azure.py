...
class TestAzure:
    ...
    def _logger_with_filter(self) -> logging.Logger:
    ...
    def test_implicit_deployment_path(self, client: Client) -> None:
    ...
    def test_client_copying(self, client: Client, method: Literal["copy", "with_options"]) -> None:
        if method == "copy":
            copied = client.copy()
        else:
    ...
    def test_client_copying_override_options(self, client: Client) -> None:
        copied = client.copy(
    ...
    @pytest.mark.respx()
    def test_client_token_provider_refresh_sync(self, respx_mock: MockRouter) -> None:
        respx_mock.post(
    ...
    @pytest.mark.asyncio
    @pytest.mark.respx()
    async def test_client_token_provider_refresh_async(self, respx_mock: MockRouter) -> None:
        respx_mock.post(
            "https://example-resource.azure.openai.com/openai/deployments/gpt-4/chat/completions?api-version=2024-02-01"
        ).mock(
            side_effect=[
    ...
    @pytest.mark.respx()
    def test_azure_api_key_redacted(self, respx_mock: MockRouter, _logger_with_filter: logging.Logger, caplog: pytest.LogCaptureFixture) -> None:
        respx_mock.post(
    ...
    @pytest.mark.respx()
    def test_azure_bearer_token_redacted(self, respx_mock: MockRouter, _logger_with_filter: logging.Logger, caplog: pytest.LogCaptureFixture) -> None:
        respx_mock.post(
            "https://example-resource.azure.openai.com/openai/deployments/gpt-4/chat/completions?api-version=2024-06-01"
        ).mock(
            return_value=httpx.Response(200, json={"model": "gpt-4"})
    ...
    @pytest.mark.asyncio
    @pytest.mark.respx()
    async def test_azure_api_key_redacted_async(self, respx_mock: MockRouter, _logger_with_filter: logging.Logger, caplog: pytest.LogCaptureFixture) -> None:
        respx_mock.post(
            "https://example-resource.azure.openai.com/openai/deployments/gpt-4/chat/completions?api-version=2024-06-01"
        ).mock(
            return_value=httpx.Response(200, json={"model": "gpt-4"})
    ...
    @pytest.mark.asyncio
    @pytest.mark.respx()
    async def test_azure_bearer_token_redacted_async(self, respx_mock: MockRouter, _logger_with_filter: logging.Logger, caplog: pytest.LogCaptureFixture) -> None:
        respx_mock.post(
            "https://example-resource.azure.openai.com/openai/deployments/gpt-4/chat/completions?api-version=2024-06-01"
        ).mock(
            return_value=httpx.Response(200, json={"model": "gpt-4"})
