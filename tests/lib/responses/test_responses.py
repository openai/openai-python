...
@pytest.mark.respx(base_url=base_url)
def test_parse_ignores_null_output_text_items(client: OpenAI, respx_mock: MockRouter) -> None:
    ...
    assert response.output[0].content[1].parsed == Payload(message="hello")
