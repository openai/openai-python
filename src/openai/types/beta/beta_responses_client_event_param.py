...
from .beta_response_prompt_param import BetaResponsePromptParam
...
ResponseCreateConversation: TypeAlias = Union[str, BetaResponseConversationParamParam]
...
class ResponseCreateMultiAgent(TypedDict, total=False):
...
class ResponseCreateToolChoiceBetaSpecificProgrammaticToolCallingParam(TypedDict, total=False):
...
class ResponseCreate(TypedDict, total=False):
    ...
    input: Union[str, BetaResponseInputParam]
    ...
    text: BetaResponseTextConfigParam
