...
from .beta_response_steer_pending_reason import BetaResponseSteerPendingReason
from .beta_response_steer_required_input import BetaResponseSteerRequiredInput

__all__ = ["BetaResponseSteerPendingEvent", "Steer"]
...
class BetaResponseSteerPendingEvent(BaseModel):
    """
    ...
    required_input: List[BetaResponseSteerRequiredInput]
    """
