...
from .beta_response_input_message_item import BetaResponseInputMessageItem
...
from .beta_response_custom_tool_call_item import BetaResponseCustomToolCallItem
...
BetaResponseItem: TypeAlias = Annotated[
    Union[
