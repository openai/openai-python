...
from .beta_response_steer_input import BetaResponseSteerInput
from .beta_response_steer_error_code import BetaResponseSteerErrorCode

__all__ = ["BetaResponseSteerFailedEvent", "Error", "Steer"]


class Error(BaseModel):
    """Information about why the input could not be committed."""

    code: BetaResponseSteerErrorCode
...
class BetaResponseSteerFailedEvent(BaseModel):
    """
