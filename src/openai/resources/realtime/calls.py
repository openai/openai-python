...
from ..._multipart import encode_multipart
...
class Calls(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        multipart_body = maybe_transform(
            {
                "sdp": sdp,
                "session": session,
            },
        ...
        multipart_body, multipart_files, multipart_content, content_type = encode_multipart(
            multipart_body,
            extra_body,
            {"sdp": ("application/sdp", False), "session": ("application/json", True)},
            "sdp",
            None,
        )
        extra_body = None
        extra_headers = {
            **{key: value for key, value in (extra_headers or {}).items() if key.lower() != "content-type"},
...
class AsyncCalls(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        # multipart/form-data; boundary=---abc--
        extra_headers = {"Content-Type": "multipart/form-data", **(extra_headers or {})}
        multipart_body = await async_maybe_transform(
            {
                "sdp": sdp,
                "session": session,
            },
