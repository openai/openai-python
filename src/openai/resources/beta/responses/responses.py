...
from ....types.beta import (
    ...
    beta_responses_client_event_param,
)
...
class Responses(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        include: Optional[List[BetaResponseIncludable]] | Omit = omit,
        input: Union[str, BetaResponseInputParam] | Omit = omit,
        ...
        multi_agent: Optional[response_create_params.MultiAgent] | Omit = omit,
        ...
        tools: Iterable[BetaToolParam] | Omit = omit,
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=BetaResponse,
            stream=stream or False,
            stream_cls=Stream[BetaResponseStreamEvent],
        )
    ...
    def cancel(
        ...
        *,
        ...
        return self._post(
            path_template("/responses/{response_id}/cancel?beta=true", response_id=response_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            ...
            cast_to=BetaResponse,
            stream=stream or False,
            stream_cls=AsyncStream[BetaResponseStreamEvent],
        )
...
class AsyncResponsesConnection:
    ...
    def parse_event(self, data: str | bytes) -> BetaResponsesServerEvent:
        """
        Converts a raw `str` or `bytes` message into a `BetaResponsesServerEvent` object.

        This is helpful if you're using `.recv_bytes()`.
        """
        return cast(
            BetaResponsesServerEvent,
            construct_type_unchecked(value=json.loads(data), type_=cast(Any, BetaResponsesServerEvent)),
        )
...
class AsyncResponsesConnectionManager:
    ...
    **Warning**: You must remember to close the connection with `.close()`.
    ...
    ```py
    connection = await client.beta.responses.connect(...).enter()
    # ...
...
class ResponsesConnection:
    ...
    def __iter__(self) -> Iterator[BetaResponsesServerEvent]:
        """
        An infinite-iterator that will continue to yield events until
        the connection is closed.
        """
    ...
    def recv(self) -> BetaResponsesServerEvent:
        """
        Receive the next message from the connection and parses it into a `BetaResponsesServerEvent` object.
...
class ResponsesConnectionManager:
    """
    Context manager over a `ResponsesConnection` that is returned by `beta.responses.connect()`
...
class ResponsesResponseResource(BaseResponsesConnectionResource):
    ...
    def create(
        ...
        *,
        ...
        | Omit = omit,
        conversation: Optional[beta_responses_client_event_param.ResponseCreateConversation] | Omit = omit,
        include: Optional[List[BetaResponseIncludable]] | Omit = omit,
        input: Union[str, BetaResponseInputParam] | Omit = omit,
        instructions: Optional[str] | Omit = omit,
        max_output_tokens: Optional[int] | Omit = omit,
        ...
        | Omit = omit,
        moderation: Optional[beta_responses_client_event_param.ResponseCreateModeration] | Omit = omit,
        multi_agent: Optional[beta_responses_client_event_param.ResponseCreateMultiAgent] | Omit = omit,
        parallel_tool_calls: Optional[bool] | Omit = omit,
        previous_response_id: Optional[str] | Omit = omit,
        prompt: Optional[BetaResponsePromptParam] | Omit = omit,
        prompt_cache_key: Optional[str] | Omit = omit,
        ...
        temperature: Optional[float] | Omit = omit,
        text: BetaResponseTextConfigParam | Omit = omit,
        tool_choice: beta_responses_client_event_param.ResponseCreateToolChoice | Omit = omit,
        tools: Iterable[BetaToolParam] | Omit = omit,
        top_logprobs: Optional[int] | Omit = omit,
        top_p: Optional[float] | Omit = omit,
        truncation: Optional[Literal["auto", "disabled"]] | Omit = omit,
