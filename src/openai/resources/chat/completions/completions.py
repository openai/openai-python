...
class Completions(SyncAPIResource):
    ...
    def parse(
        ...
        *,
        ...
        guided_choice_expr: Optional[completion_create_params.ExprValue] | NotGiven = NOT_GIVEN,
        guided_json_expr: Optional[completion_create_params.ExprValue] | NotGiven = NOT_GIVEN,
        guided_regex_expr: Optional[completion_create_params.ExprValue] | NotGiven = NOT_GIVEN,
            ...
            body=maybe_transform(
                {
                    ...
                    "functions": functions,
                    "guided_choice": guided_choice_expr,
                    "guided_json": guided_json_expr,
                    "guided_regex": guided_regex_expr,
    ...
    def stream(
        ...
        *,
        ...
        api_request: partial[Stream[ChatCompletionChunk]] = partial(
            ...
            function_call=function_call,
            functions=functions,
            guided_choice_expr=guided_choice_expr,
            guided_json_expr=guided_json_expr,
            guided_regex_expr=guided_regex_expr,
            logit_bias=logit_bias,
            logprobs=logprobs,
            max_completion_tokens=max_completion_tokens,
            max_tokens=max_tokens,
