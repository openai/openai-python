...
- Import `SocketTimeoutError` explicitly so older aiohttp installations raise `ImportError`, allowing the SDK to disable the optional adapter without breaking its default clients.
